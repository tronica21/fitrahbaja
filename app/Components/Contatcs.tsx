...
export default function Contatcs() {
	return (
		<section className="py-10 lg:py-[60px] overflow-hidden relative z-10 container max-w-6xl mx-auto">
			<h2 className="mb-4 text-3xl font-bold uppercase text-accent md:text-5xl lg:text-[36px] xl:text-[40px]">
				MARI BERSILATURAHMI
			</h2>
				...
				<div className="flex flex-wrap items-center lg:justify-between">
					<div className="w-full px-4 md:w-1/2 xl:w-6/12">
						<div className="mb-12 max-w-[570px] lg:mb-0">
							<p className="text-sm md:text-lg leading-relaxed mb-6 text-body-color">
								Ciptakan Komunikasi yang hangat dengan tim kami, kami akan
								membantu anda menemukan produk besi/baja berkualitas untuk
								kebutuhan project. Kami juga menerima masukan saran dan kritik,
								untuk memberikan layanan pelanggan yang lebih baik kedepan.
							</p>
							<div className="mb-8 flex w-full max-w-[370px]">
								...
								<div className="w-full">
									<h4 className="mb-1 text-xl font-bold text-accent">
										Lokasi Kantor / Toko
									</h4>
									<p className="text-base text-body-color">
										Jl Setiabudi No. 18 Pamulang Timur, Kota Tangerang Selatan
										15417, Banten - Indonesia
									</p>
								</div>
							</div>
							<div className="mb-8 flex w-full max-w-[370px]">
								...
								<div className="w-full">
									...
									<p className="text-base text-body-color">
										(+62)21 743 2000 (+62)812 8336 6200
									</p>
								</div>
							</div>
							<div className="mb-8 flex w-full max-w-[370px]">
					...
					<div className="w-full px-4 md:w-1/2 xl:w-5/12">
						<div className="relative p-4 bg-yellow-50 rounded-lg shadow-lg sm:p-12">
							<form>
								<ContactInputBox
									type="text"
									name="name"
								...
								<div>
									<button
										type="submit"
										className="w-full p-3 text-base text-gray-100 bg-primary-100 hover:bg-primary-200 transition border rounded border-primary bg-primary hover:bg-opacity-90"
									>
										Send Message
									</button>
								</div>
...
const ContactTextArea = (props: any) => {
	return (
		<>
			<div className="mb-6">
				<textarea
					...
					name={props.name}
					className="border-primary-100/50 w-full resize-none rounded border py-3 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
...
const ContactInputBox = (props: any) => {
	return (
		<>
			<div className="mb-6">
				<input
					...
					placeholder={props.placeholder}
					name={props.name}
					className="border-primary-100/50 w-full rounded border py-2 px-[14px] text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none"
				/>
			</div>
		</>
	);
